...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+fCQll5ABpTc3ZTU1')
SPRT_GRP = environ.get('SPRT_GRP', 'https://t.me/+fCQll5ABpTc3ZTU1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+fCQll5ABpTc3ZTU1')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/+fCQll5ABpTc3ZTU1')
...
URL = "https://autofilestream-636a63c76a3a.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autofilestream-636a63c76a3a.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://autofilestream-636a63c76a3a.herokuapp.com/".format(FQDN)
else:
    URL = "https://autofilestream-636a63c76a3a.herokuapp.com/".format(FQDN)
