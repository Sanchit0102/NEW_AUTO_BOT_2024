...
BOT_TOKEN = environ.get('BOT_TOKEN', "6970232543:AAFBDXOGAP-sm7Bsys0m4c9PXmGgKm8uTrE")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001644930682').split()]
