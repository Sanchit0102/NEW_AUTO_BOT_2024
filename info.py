...
URL = "https://auto-group.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://auto-group.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://auto-group.onrender.com/".format(FQDN)
else:
    URL = "https://auto-group.onrender.com/".format(FQDN)
