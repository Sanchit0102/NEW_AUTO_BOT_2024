...
URL = "https://filestreammmabhi-e982f67471ba.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filestreammmabhi-e982f67471ba.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filestreammmabhi-e982f67471ba.herokuapp.com/".format(FQDN)
else:
    URL = "https://filestreammmabhi-e982f67471ba.herokuapp.com/".format(FQDN)
